...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libpsl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libpsl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libpsl libpsl-static
# for installing globally
pixi global install libpsl libpsl-static
```
...
It is possible to list all of the versions of `libpsl` available on your platform:
...
```
pixi search libpsl --channel conda-forge
```
